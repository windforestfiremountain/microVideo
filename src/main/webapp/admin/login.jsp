...
<%--                            name属性为key,用户输入的属性值为值。--%>
                            <input type="text" class="form-control" id="account" name="account" value="admin" placeholder="请输入账号">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-md-3"></div>
                        <div class="col-md-6" style="text-align: center">
                            <a class="btn btn-warning"  style="margin-bottom: 10px" href="/front/login.jsp">切换为用户登录</a>
                        </div>
                        <div class="col-md-3"></div>
                    </div>
                </form>
