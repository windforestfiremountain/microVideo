...
<%--                    下拉菜单--%>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="createTime" name="createTime" onClick="WdatePicker({el:this,dateFmt:'yyyy-MM-dd HH:mm:ss'})"  placeholder="请输入创建时间" readonly="readonly">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="timeLength" name="timeLength" placeholder="请输入时长">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="videoPath" class="col-sm-2 control-label">视频:</label>
                        <div class="col-sm-10">
