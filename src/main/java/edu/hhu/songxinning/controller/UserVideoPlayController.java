...
@WebServlet("/userVideoPlay")
public class UserVideoPlayController extends HttpServlet {
    ...
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //页面跳转
        request.getRequestDispatcher("/front/uservideoplay.jsp").forward(request,response);
